...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale()
  {
   ...
   for (Pixel[] rowArray : pixels)
   {
      for (Pixel pixelObj : rowArray)
      {
         int newColour = (pixelObj.getRed() + pixelObj.getGreen() + pixelObj.getBlue()) / 3;
         pixelObj.setRed(newColour);
         pixelObj.setGreen(newColour);
         pixelObj.setBlue(newColour);
      }
   }
  }
